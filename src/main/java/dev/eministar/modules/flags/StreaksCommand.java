...
public class StreaksCommand implements Command {
    @Override
    public String name() { return "streaks"; }

    @Override
    public String description() { return "Zeigt die aktuellen Streaks der Spieler"; }
    ...
    public void execute(MessageReceivedEvent event, String[] args) {
        ...
        String text = FlagQuizService.streaksText(guild.getId(), event.getJDA(), 10);
